...
public class JSONParser {
	...
	public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException {
		...
		Student[] students=root.getStudents();
		Progression[] progressions=students[0].getProgressions();
		Subject[] subjects = progressions[0].getSubjects();
		Test[] tests=subjects[0].getTests();
